...
<head>
	...
	<link href="/senmiao/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/senmiao/statics/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/senmiao/statics/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/senmiao/statics/simpleboot/font-awesome/4.2.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
	...
	<!--[if IE 7]>
	<link rel="stylesheet" href="/senmiao/statics/simpleboot/font-awesome/4.2.0/css/font-awesome-ie7.min.css">
	<![endif]-->
...
<!-- Le javascript
    ...
    <script src="/senmiao/statics/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
.list-dot li a.close,.list-dot-othors li a.close{ background: url("/senmiao/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
        ...
        <tr>
          <td>
			...
			<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
				<?php if(empty($smeta['thumb'])): ?><img src="/senmiao/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
				<?php else: ?>
            ...
            <input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','/senmiao/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
        <tr>
      ...
      <table width="100%"  cellpadding="2" cellspacing="2">
            ...
            <tr>
              ...
              <td><span class="must_red">*</span><div id='content_tip'></div>
                ...
                <script type="text/javascript"  src="/senmiao/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/senmiao/statics/js/ueditor/ueditor.all.min.js"></script>
				</td>
            </tr>
        </tbody>
      </table>
...
<script type="text/javascript" src="/senmiao/statics/js/common.js"></script>
<script type="text/javascript" src="/senmiao/statics/js/content_addtop.js"></script>
<script type="text/javascript"> 
$(function () {
