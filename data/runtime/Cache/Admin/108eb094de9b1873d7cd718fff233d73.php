...
.table_list tr.expanded td .expander{
	background: url(/senmiao/tpl_admin/simpleboot/assets/images/tv-collapsable.gif) center center no-repeat;
}
.table_list tr.collapsed td .expander{
	background: url(/senmiao/tpl_admin/simpleboot/assets/images/tv-expandable.gif) center center no-repeat;
}
</style>
...
$(function(){
    $(".show_sub").click(function(){
        $(this).attr("src",function(){
            if(this.src == '/senmiao/tpl_admin/simpleboot/assets/images/tv-expandable.gif'){
                return '/senmiao/tpl_admin/simpleboot/assets/images/tv-collapsable.gif';
            } else {
                return '/senmiao/tpl_admin/simpleboot/assets/images/tv-expandable.gif';
            }
        });
