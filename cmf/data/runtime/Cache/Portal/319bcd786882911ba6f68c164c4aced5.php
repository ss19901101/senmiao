...
<head>
	...
	<link href="/cmf/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="/cmf/statics/simpleboot/css/simplebootadmin.css" rel="stylesheet">
    <link href="/cmf/statics/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="/cmf/statics/simpleboot/font-awesome/4.2.0/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
...
<!-- Le javascript
    ...
    <script src="/cmf/statics/js/jquery.js"></script>
    <script src="/cmf/statics/js/wind.js"></script>
    <script src="/cmf/statics/simpleboot/bootstrap/js/bootstrap.min.js"></script>
...
.list-dot li a.close,.list-dot-othors li a.close{ background: url("/cmf/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
      ...
      <table width="100%">
        ...
        <tr>
          <td>
			...
			<?php if(empty($smeta['thumb'])): ?><img src="/cmf/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
            ...
            <input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','/cmf/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
        <tr>
      ...
      <table width="100%"  cellpadding="2" cellspacing="2">
            ...
            <tr>
              ...
              <td><span class="must_red">*</span><div id='content_tip'></div>
                ...
                <script type="text/javascript"  src="/cmf/statics/js/ueditor/ueditor.config.js"></script>
                <script type="text/javascript"  src="/cmf/statics/js/ueditor/ueditor.all.min.js"></script>
				<script type="text/javascript">
    			var editorcontent;
              ...
              <td>
		        ...
		        <ul id="photos" class="picList">
			        <?php if(is_array($smeta['photo'])): foreach($smeta['photo'] as $key=>$vo): ?><li id="savedimage<?php echo ($key); ?>">
				        	<input type="text" name="photos_url[]" value="/cmf/data/upload/<?php echo ($vo['url']); ?>" title='双击查看' style="width:310px;" ondblclick="image_priview(this.value);" class="input">
...
<script type="text/javascript" src="/cmf/statics/js/common.js"></script>
<script type="text/javascript" src="/cmf/statics/js/content_addtop.js"></script>
<script type="text/javascript"> 
$(function () {
