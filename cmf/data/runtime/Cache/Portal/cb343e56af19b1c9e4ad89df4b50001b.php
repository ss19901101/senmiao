...
</section><section class="resourcont wp">
		<h5 class="tit"><?php echo ($post_title); ?></h5>
		<div class="time">发布时间:<?php echo ($post_date); ?></div></div>
		<span style="color: rgb(97, 97, 98); font-family: 'Microsoft YaHei UI', 'Microsoft YaHei', Arial, SimSun, 'Segoe UI', Tahoma, Helvetica, sans-serif; font-size: 14px; line-height: 30px; ">岗位描述：</span><?php echo ($post_content); ?>
