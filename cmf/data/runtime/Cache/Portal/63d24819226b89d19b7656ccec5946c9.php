...
<section id="banner">
	<div class="banwrapper">
		<ul>
          	<li class="cur crf"><img src="/cmf/tpl/bs/Public/Pic/banner1.jpg" alt="" />
			...
			<li class=""><img src="/cmf/tpl/bs/Public/Pic/banner4.jpg" alt="" />
				<div class="wp setanima">
			...
			<li class=""><img src="/cmf/tpl/bs/Public/Pic/banner3.jpg" alt="" />
				<div class="wp setanima">
			...
			<li class=""><img src="/cmf/tpl/bs/Public/Pic/banner2.jpg" alt="" />
				<div class="wp setanima">
			...
			<li class=""><img src="/cmf/tpl/bs/Public/Pic/banner5.jpg" alt="" />
				<div class="wp setanima">
			...
			<li class=""><img src="/cmf/tpl/bs/Public/Pic/banner6.jpg" alt="" />
				<div class="wp setanima">
...
<div id="holder" class="bancotr">
	<img name="newico" src="/cmf/tpl/bs/Public/Pic/new-ico.png" width="320" height="160" border="0" id="newico" usemap="#m_newico" alt="" />
    ...
    <div class="bg">
      <img id="pointer" src="/cmf/tpl/bs/Public/Pic/pointer.png">
    </div>
	</div>
</section>
...
<section id="products">
		<div class="wp">
		<h2 id="prohst"><a href="/cmf/list/index/id/4">产品中心<br /><i>Product</i></a></h2>
		<ul class="clearfix">

<li><a href="/cmf/list/index/id/5"><img src="/cmf/tpl/bs/Public/Pic/20140522055219211.png" alt="" /></a>
				<span>装饰板</span></li>
<li><a href="/cmf/list/index/id/6"><img src="/cmf/tpl/bs/Public/Pic/20140523091125830.png" alt="" /></a>
				<span>金属装饰线条</span></li>
<li><a href="/cmf/list/index/id/7"><img src="/cmf/tpl/bs/Public/Pic/20140523091151851.png" alt="" /></a>
				<span>金属装饰板</span></li>
<li><a href="/cmf/list/index/id/8"><img src="/cmf/tpl/bs/Public/Pic/20140523091213973.png" alt="" /></a>
				<span>质感装饰砂浆</span></li>
<li><a href="/cmf/list/index/id/9"><img src="/cmf/tpl/bs/Public/Pic/20140523091347781.png" alt="" /></a>
				<span>干混砂浆</span></li>
...
<section id="superiority">
    ...
    <li class="cur">
      <img class="lazy" src="/cmf/tpl/bs/Public/Pic/about_blank.png" data-original="/cmf/tpl/bs/Public/Images/20140516101724521.jpg" alt="保温<i>隔音</i>">
    </li>
	    <li>
      <img class="lazy" src="/cmf/tpl/bs/Public/Pic/about_blank.png"  data-original="/cmf/tpl/bs/Public/Images/20140514105849209.jpg" alt="A级<i>防火</i>">
    </li>
        <li>
      <img class="lazy" src="/cmf/tpl/bs/Public/Pic/about_blank.png"  data-original="/cmf/tpl/bs/Public/Images/20140514105937792.jpg" alt="品质<i>质量</i>">
    </li>
        <li>
      <img class="lazy" src="/cmf/tpl/bs/Public/Pic/about_blank.png"  data-original="/cmf/tpl/bs/Public/Images/20140514110035284.jpg" alt="时间<i>效率</i>">
    </li>
        <li>
      <img class="lazy" src="/cmf/tpl/bs/Public/Pic/about_blank.png"  data-original="/cmf/tpl/bs/Public/Images/20140514110116465.jpg" alt="绿色<i>环保</i>">
    </li>
      </ul>
...
<div id="casebar"></div>
	<div class="wp">
	   <h2 id="caseIn"><a href="/cmf/list/index/id/17">工程案例<br /><i>CASE</i></a></h2>
	   <div class="desp">
...
<?php $content=sp_sql_posts_paged('cid:17;field:tid,post_title,smeta;limit 4;'); ?>
	  ...
	  <?php if(is_array($content['posts'])): foreach($content['posts'] as $key=>$vo): ?><li><a class="fangdajing" href="/cmf/article/index/id/<?php echo ($vo["tid"]); ?>"><i></i></a>
				<a class="beijing" href="/cmf/article/index/id/<?php echo ($vo["tid"]); ?>"><i><?php echo ($vo["post_title"]); ?></i></a>
				    <?php $smeta=json_decode($vo['smeta'],true); ?>
				<img src="/cmf/data/upload/<?php echo ($smeta["thumb"]); ?>" alt=""  width="250" height="162"/>
...
<?php $list=sp_sql_posts_paged('cid:19,20;field:tid,post_title,smeta;limit 3;'); ?>
  <?php if(is_array($list['posts'])): foreach($list['posts'] as $key=>$vo): ?><li class="first">
				...
				<h3><a class="" href="/cmf/article/index/id/<?php echo ($vo["tid"]); ?>"><?php echo ($vo["post_title"]); ?></a></h3>
				<div class="data"><?php echo ($vo["post_excrept"]); ?>..</div>
				<a class="more" href="/cmf/article/index/id/<?php echo ($vo["tid"]); ?>">Read More</a>
			</li><?php endforeach; endif; ?>
...
<script type="text/javascript" src="/cmf/tpl/bs/Public/Js/raphael-min.js"></script>
<script type="text/javascript" src="/cmf/tpl/bs/Public/Js/jqueryrotate.js"></script>
