...
<?php if(is_array($terms)): foreach($terms as $key=>$vo): ?><li><a href='/cmf/list/index/id/<?php echo ($vo["term_id"]); ?>'><?php echo ($vo["name"]); ?></a> </li><?php endforeach; endif; ?>
	...
	<div class="wp">
		<div class="formtit clearfix">		
        		...
        		<div class="prcont">
			<ul class="clearfix">
            			<?php $lists = sp_sql_posts_paged("cid:5,6,7;order:post_date DESC;",10); ?>    
				  <?php if(is_array($lists['posts'])): $i = 0; $__LIST__ = $lists['posts'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; $smeta=json_decode($vo['smeta'], true); ?>
                        <li  class="fourth"><a  class="mian"  href="<?php echo U('article/index',array('id'=>$vo['tid']));?>"><img src="/cmf/data/upload/<?php echo ($smeta["thumb"]); ?>" alt="<?php echo ($vo["post_title"]); ?>" /></a>
					<div class="despt">
	...
	<div class="pager"><?php echo ($lists['page']); ?>
</div>
			</div>
</section>
