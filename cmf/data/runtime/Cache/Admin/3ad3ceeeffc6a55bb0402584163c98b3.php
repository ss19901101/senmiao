...
<![endif]-->
<link rel="stylesheet" href="/cmf/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/cmf/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
